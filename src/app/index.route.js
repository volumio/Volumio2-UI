  ...
  $stateProvider
    ...
    .state('volumio.multi-room', {
      ...
      views: {
        'content@volumio': {
          templateUrl:
            'app/themes/axiom/multi-room-manager/axiom-multi-room-manager.html',
    ...
    .state('myvolumio.edit-profile', {
      ...
      views: {
        'content@myvolumio': {
          templateUrl:
            'app/plugin/core-plugin/auth/edit-profile/auth-edit-profile.html',
    ...
    .state('myvolumio.subscribe', {
      ...
      views: {
        'content@myvolumio': {
          templateUrl:
            'app/plugin/core-plugin/auth/subscribe/auth-subscribe.html',
    ...
    .state('myvolumio.payment-success', {
      ...
      views: {
        'content@myvolumio': {
          templateUrl:
            'app/plugin/core-plugin/auth/payment-success/auth-payment-success.html',
    ...
    .state('myvolumio.payment-fail', {
      ...
      views: {
        'content@myvolumio': {
          templateUrl:
            'app/plugin/core-plugin/auth/payment-fail/auth-payment-fail.html',
    ...
    .state('myvolumio.recover-password', {
      ...
      views: {
        'content@myvolumio': {
          templateUrl:
            'app/plugin/core-plugin/auth/recover-password/auth-recover-password.html',
    ...
    .state('myvolumio.verify-user', {
      ...
      views: {
        'content@myvolumio': {
          templateUrl:
            'app/plugin/core-plugin/auth/verify-user/auth-verify-user.html',
    ...
    .state('myvolumio.cancel-subscription', {
      ...
      views: {
        'content@myvolumio': {
          templateUrl:
            'app/plugin/core-plugin/auth/cancel-subscription/auth-cancel-subscription.html',
    ...
    .state('myvolumio.change-subscription', {
      ...
      views: {
        'content@myvolumio': {
          templateUrl:
            'app/plugin/core-plugin/auth/change-subscription/auth-change-subscription.html',
